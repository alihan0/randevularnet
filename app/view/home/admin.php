...
switch ($request[3]) {
    case 'all':
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18"><?=Lang::line("page","admin")?></h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="/"><?=Lang::line("page","home")?></a></li>
                            <li class="breadcrumb-item"><a href="/home/admin/all"><?=Lang::line("page","admin")?></a></li>
                            <li class="breadcrumb-item active"> <?=Lang::line("page","admin_all")?></li>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item active"><a class="page-link" href="javscript:void(0)"><?=Lang::line("page","admin_all")?></a></li>
                <li class="page-item"><a class="page-link" href="/home/admin/add"><?=Lang::line("page","admin_add")?></a></li>

            </ul>
        </nav>

        <table id="adminTable" class="table table-bordered dt-responsive  nowrap w-100">
            <thead>
            <tr>   
            ...
            <tbody>
            <?php 
                $select = $db->selectAnd("accounts",["type"=>"ADMIN"]);
                $count = count($select);
                for($i=0;$i<$count;$i++){
                    ?>
                    <tr>
    ...
    case 'add':
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="/"><?=Lang::line("page","home")?></a></li>
                            <li class="breadcrumb-item"><a href="/home/admin/all"><?=Lang::line("page","admin")?></a></li>
                            <li class="breadcrumb-item active"> <?=Lang::line("page","admin_add")?></li>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item "><a class="page-link" href="/home/admin/all"><?=Lang::line("page","admin_all")?></a></li>
                <li class="page-item active"><a class="page-link" href="javscript:void(0)"><?=Lang::line("page","admin_add")?></a></li>
            </ul>
        </nav>
        ...
        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4"><?=Lang::line("page","admin_add")?></h4>
                                        ...
                                        <form id="formAddAdmin">
                                            ...
                                            <div>
                                                <button type="submit" class="btn btn-primary w-md" id="btnAddAdmin"><?=Lang::line("button","save")?></button>
                                            </div>
                                        </form>
                                    </div>
                                    <!-- end card body -->
