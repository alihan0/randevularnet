...
Class dbConfig extends PDO {
    ...
    protected function createConfig() {
        ...
        $this->dbConfig['username'] = 'metatige_queen';
        $this->dbConfig['password'] = 'Z8HHL5MOfN';
        $this->dbConfig['dbname'] = 'metatige_queen';
    }
...
Class Database extends dbConfig {
	...
	function __construct() {
		...
		try{
			...
			$this->connection = new PDO($dsn, $this->dbConfig['username'], $this->dbConfig['password']);
            		$this->connection->query("SET NAMES utf8mb4_general_ci");
        	 	$this->connection->query("SET CHARACTER SET utf8mb4_general_ci");
            		$this->connection->query("SET COLLATION_CONNECTION = 'utf8mb4_general_ci");
			return true;
	...
	public function insert($table, $array) {
        ...
        if ($insert) {
			...
			echo json_encode(["type"=>"success","message"=>Lang::line("success","successfull"),"return"=>true]);
        } else {
            echo json_encode(["type"=>"warning","message"=>Lang::line("error","unsuccessfull"),"return"=>false]);
        }
	}
