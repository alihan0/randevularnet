!function(t) {
    ...
    function n(e) {
        ...
        t("#bootstrap-style").attr("href", "/static/assets/css/bootstrap.min.css"), t("#app-style").attr("href", "/static/assets/css/app.min.css"), 
        ...
        $("#dark-mode-switch").remove(),t(".theme-switch").append('<input type="checkbox" class="form-check-input waves-effect theme-choice" id="light-mode-switch" checked />'),t("#light-mode-switch").prop("checked"),
        t("#light-mode-switch").prop("checked", !1), t("#rtl-mode-switch").prop("checked", !1), 
        t("#bootstrap-style").attr("href", "/static/assets/css/bootstrap-dark.min.css"), 
        t("#app-style").attr("href", "/static/assets/css/app-dark.min.css"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == t("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (t("#light-mode-switch").prop("checked", !1), 
        t("#dark-mode-switch").prop("checked", !1), t("#bootstrap-style").attr("href", "/static/assets/css/bootstrap-rtl.min.css"), 
        t("#app-style").attr("href", "/static/assets/css/app-rtl.min.css"), t("html").attr("dir", "rtl"), 
    ...
    t("#side-menu").metisMenu(), t("#vertical-menu-btn").on("click", function(e) {
        ...
        t(this).parent().parent().parent().addClass("mm-active"), t(this).parent().parent().parent().parent().addClass("mm-show"), 
        ...
        t(this).parent().parent().addClass("active"), t(this).parent().parent().parent().addClass("active"), 
        t(this).parent().parent().parent().parent().addClass("active"), t(this).parent().parent().parent().parent().parent().addClass("active"), 
    ...
    t("#" + a).prop("checked", !0), n(a)) : sessionStorage.setItem("is_visited", "light-mode-switch")), 
